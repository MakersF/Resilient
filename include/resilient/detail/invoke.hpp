...
template<typename F, typename... Args>
struct is_invocable<decltype(void(INVOKE(std::declval<F>(), std::declval<Args>()...))), F, Args...>
: std::true_type
{
};
...
template<typename F, typename... Args>
struct is_nothrow_invocable<true, F, Args...>
...
template<typename F, typename... Args>
invoke_result_t<F, Args...> invoke(F&& f,
                                   Args&&... args) noexcept(is_nothrow_invocable<F, Args...>::value)
{
